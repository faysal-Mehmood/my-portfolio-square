...
const Resume = () => {
  ...
  const resumeHighlights = [
    ...
    },
    {
      title: "Data Analyst",
      description:
        "Skilled in data analysis and visualization. Experienced in web data scraping and preparing clean, structured datasets for decision-making.",
          ...
          >
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-muted-foreground">
                I'm an aspiring developer specializing in Software development,
                AI, and machine learning. My goal is to leverage these
                technologies to create innovative solutions for real-world
                problems.
              </p>
            </div>
          </motion.div>
