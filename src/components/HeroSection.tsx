    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div
              className="relative w-[360px] h-[360px] md:w-[500px] md:h-[500px] rounded-full overflow-hidden glass-panel p-2 flex items-center justify-center"
              animate={{
                boxShadow: [
                ...
                // rotate: [0, 3, -3, 0], // Subtle rotation animation
              }}
              transition={{
                duration: 6, // Increased duration for slower, more elegant rotation
                repeat: Number.POSITIVE_INFINITY,
                ease: "easeInOut",
              }}
            >
              {/* Removed the inner circular background div */}
              <motion.img
                src="/uploads/profile.svg"
                alt="Uday G's Profile Photo"
                className="w-full h-full object-fill rounded-full relative z-10"
